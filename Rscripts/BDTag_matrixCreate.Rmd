...
Adapter trimming of sequencing data was performed by using cutadapt 2.10.  
Filtered reads were chunked to 16 parts for parallel processing by using Seqkit 0.9.0.  
Filtered cell barcode reads were annotated by Python script provided by BD with minor modification for compatible to Python3.7.  
...
Resulted count data was converted to Tags x cells matrix file by using data.table package in R 3.6.3, and top 1M cell barcodes were extracted.
